...
public class CmdFactionsMap extends FactionsCommand {
	...
	public void showMap(int width, int height) {
		...
		List<Object> message = BoardColl.get().getMap(msenderFaction, PS.valueOf(location), location.getYaw(), width,
				height);
		message(message);
	}
}
 ...
 * CmdFactionsMap.class Java compiler version: 8 (52.0) JD-Core Version: 0.7.1
 */