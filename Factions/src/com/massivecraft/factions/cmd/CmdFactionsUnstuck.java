...
public class CmdFactionsUnstuck extends FactionsCommand {
	...
	public void perform() throws MassiveException {
		...
		if (location == null) {
			msg("<b>No nearby chunk with %s<b> or build rights found.",
					new Object[] { FactionColl.get().getNone().describeTo(msender) });
			return;
		}
 ...
 * CmdFactionsUnstuck.class Java compiler version: 8 (52.0) JD-Core Version:
 * 0.7.1
 */