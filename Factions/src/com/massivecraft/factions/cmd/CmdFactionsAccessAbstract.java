...
public abstract class CmdFactionsAccessAbstract extends FactionsCommand {
	...
	public void sendAccessInfo() {
		...
		msg("<k>Host Faction Allowed: %s",
				new Object[] { ta.isHostFactionAllowed() ? Txt.parse("<lime>TRUE") : Txt.parse("<rose>FALSE") });
		msg("<k>Granted Players: %s", new Object[] { describeRelationParticipators(ta.getGrantedMPlayers(), msender) });
		msg("<k>Granted Factions: %s",
				new Object[] { describeRelationParticipators(ta.getGrantedFactions(), msender) });
	}
 ...
 * CmdFactionsAccessAbstract.class Java compiler version: 8 (52.0) JD-Core
 * Version: 0.7.1
 */