...
public class CmdFactionsUnsethome extends FactionsCommandHome {
	...
	public void perform() throws MassiveException {
		...
		faction.msg("%s<i> unset the home for your faction.",
				new Object[] { msender.describeTo(msenderFaction, true) });
 ...
 * CmdFactionsUnsethome.class Java compiler version: 8 (52.0) JD-Core Version:
 * 0.7.1
 */