...
public class CmdFactionsMotd extends FactionsCommand {
	...
	public void perform() throws MassiveException {
		...
		if (MUtil.equals(old, target)) {
			msg("<i>The motd for %s <i>is already: <h>%s",
					new Object[] { msenderFaction.describeTo(msender, true), msenderFaction.getMotdDesc() });
			return;
		}
		...
		for (MPlayer follower : msenderFaction.getMPlayers()) {
			follower.msg("<i>%s <i>set your faction motd to:\n%s", new Object[] {
					MixinDisplayName.get().getDisplayName(sender, follower), msenderFaction.getMotdDesc() });
		}
	}
}
 ...
 * CmdFactionsMotd.class Java compiler version: 8 (52.0) JD-Core Version: 0.7.1
 */