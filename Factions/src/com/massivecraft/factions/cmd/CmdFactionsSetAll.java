...
public class CmdFactionsSetAll extends CmdFactionsSetXAll {
	public static final List<String> LIST_ALL = Collections
			.unmodifiableList(MUtil.list(new String[] { "a", "al", "all" }));
 ...
 * CmdFactionsSetAll.class Java compiler version: 8 (52.0) JD-Core Version:
 * 0.7.1
 */