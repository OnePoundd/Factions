...
public class CmdFactionsOverride extends FactionsCommand {
	...
	public void perform() throws MassiveException {
		...
		String messageYou = Txt.parse("<i>%s %s <i>override mode.",
				new Object[] { msender.getDisplayName(msender), desc });
		String messageLog = Txt.parse("<i>%s %s <i>override mode.",
				new Object[] { msender.getDisplayName(IdUtil.getConsole()), desc });
 ...
 * CmdFactionsOverride.class Java compiler version: 8 (52.0) JD-Core Version:
 * 0.7.1
 */