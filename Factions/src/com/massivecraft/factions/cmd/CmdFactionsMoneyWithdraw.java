...
public class CmdFactionsMoneyWithdraw extends FactionsCommand {
	...
	public void perform() throws MassiveException {
		...
		if ((success) && (MConf.get().logMoneyTransactions)) {
			Factions.get().log(new Object[] { ChatColor.stripColor(Txt.parse("%s withdrew %s from the faction bank: %s",
					new Object[] { msender.getName(), Money.format(amount.doubleValue()), from.describeTo(null) })) });
		}
	}
}
 ...
 * CmdFactionsMoneyWithdraw.class Java compiler version: 8 (52.0) JD-Core
 * Version: 0.7.1
 */