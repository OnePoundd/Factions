...
public class CmdFactionsName extends FactionsCommand {
	...
	public void perform() throws MassiveException {
		...
		if ((FactionColl.get().isNameTaken(newName))
				&& (!MiscUtil.getComparisonString(newName).equals(faction.getComparisonName()))) {
		...
		faction.msg("%s<i> changed your faction name to %s",
				new Object[] { msender.describeTo(faction, true), faction.getName(faction) });
 ...
 * CmdFactionsName.class Java compiler version: 8 (52.0) JD-Core Version: 0.7.1
 */