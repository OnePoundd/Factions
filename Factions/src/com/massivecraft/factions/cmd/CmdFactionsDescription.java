...
public class CmdFactionsDescription extends FactionsCommand {
	...
	public void perform() throws MassiveException {
		...
		EventFactionsDescriptionChange event = new EventFactionsDescriptionChange(sender, msenderFaction,
				newDescription);
		event.run();
		...
		for (MPlayer follower : msenderFaction.getMPlayers()) {
			follower.msg("<i>%s <i>set your faction description to:\n%s", new Object[] {
					MixinDisplayName.get().getDisplayName(sender, follower), msenderFaction.getDescriptionDesc() });
		}
	}
}
 ...
 * CmdFactionsDescription.class Java compiler version: 8 (52.0) JD-Core Version:
 * 0.7.1
 */