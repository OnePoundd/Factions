...
public class CmdFactionsTitle extends FactionsCommand {
	...
	public void perform() throws MassiveException {
		...
		if (!MPerm.getPermTitle().has(msender, you.getFaction(), true)) {
			return;
		}
		...
		msenderFaction.msg("%s<i> changed a title: %s",
				new Object[] { msender.describeTo(msenderFaction, true), you.describeTo(msenderFaction, true) });
	}
}

/*
 * Location: C:\Users\Alan\Desktop\Factions.jar!\com\massivecraft\factions\cmd\
 * CmdFactionsTitle.class Java compiler version: 8 (52.0) JD-Core Version: 0.7.1
 */