...
public class Const {
	...
	public static final char[] MAP_KEY_CHARS = "\\/#?£$%=&^ABCDEFGHJKLMNOPQRSTUVWXYZ–1234567890abcdeghjmnopqrsuvwxy"
			.toCharArray();
	...
	public static final String MAP_KEY_CAPITAL = ChatColor.AQUA.toString() + ChatColor.BOLD.toString();
	public static final String MAP_KEY_OVERFLOW = ChatColor.MAGIC.toString() + "-" + ChatColor.RESET.toString();
	public static final String MAP_OVERFLOW_MESSAGE = MAP_KEY_OVERFLOW + ": Too Many Factions (>" + MAP_KEY_CHARS.length
			+ ") on this Map.";
...
/*
 * Location:
 * C:\Users\Alan\Desktop\Factions.jar!\com\massivecraft\factions\Const.class
