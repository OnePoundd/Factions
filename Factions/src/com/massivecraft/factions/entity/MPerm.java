...
public class MPerm extends Entity<MPerm> implements Prioritized, Registerable, Named {
	...
	public static final transient String ID_TRUSTED = "trusted";
	public static final transient String ID_UPGRADE = "upgrade";
	public static final transient String ID_WARP = "warp";
	public static final transient String ID_DELETEWARP = "deletewarp";
	public static final transient String ID_SETWARP = "setwarp";
	public static final transient String ID_SETCAPITAL = "setcapital";
	public static final transient String ID_FLY = "fly";
	public static final transient String ID_RECRUITMENT = "recruitment";
	public static final transient String ID_URL = "url";
	...
	public static final transient int PRIORITY_TRUSTED = 999;
	public static final transient int PRIORITY_UPGRADE = 998;
	public static final transient int PRIORITY_WARP = 995;
	public static final transient int PRIORITY_DELETEWARP = 997;
	public static final transient int PRIORITY_SETWARP = 996;
	public static final transient int PRIORITY_SETCAPITAL = 995;
	public static final transient int PRIORITY_FLY = 994;
	public static final transient int PRIORITY_RECRUITMENT = 993;
	public static final transient int PRIORITY_URL = 992;
	...
	public static MPerm getPermBuild() {
		return getCreative(1000, "build", "build", "edit the terrain",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER, Rel.MEMBER }), true, true, true);
	}

	public static MPerm getPermPainbuild() {
		return getCreative(2000, "painbuild", "painbuild", "edit, take damage", new LinkedHashSet(), true, true, true);
	}

	public static MPerm getPermDoor() {
		return getCreative(3000, "door", "door", "use doors",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY }), true, true, true);
	}

	public static MPerm getPermButton() {
		return getCreative(4000, "button", "button", "use stone buttons",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY }), true, true, true);
	}

	public static MPerm getPermLever() {
		return getCreative(5000, "lever", "lever", "use levers",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY }), true, true, true);
	}

	public static MPerm getPermContainer() {
		return getCreative(6000, "container", "container", "use containers",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER, Rel.MEMBER }), true, true, true);
	}

	public static MPerm getPermName() {
		return getCreative(7000, "name", "name", "set name", MUtil.set(new Rel[] { Rel.LEADER }), false, true, true);
	}

	public static MPerm getPermDesc() {
		return getCreative(8000, "desc", "desc", "set description", MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }),
				false, true, true);
	}

	public static MPerm getPermMotd() {
		return getCreative(9000, "motd", "motd", "set motd", MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }), false,
				true, true);
	}

	public static MPerm getPermInvite() {
		return getCreative(10000, "invite", "invite", "invite players",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }), false, true, true);
	}

	public static MPerm getPermStatus() {
		return getCreative(24000, "status", "status", "show status", MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }),
				false, true, true);
	}

	public static MPerm getPermKick() {
		return getCreative(11000, "kick", "kick", "kick members", MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }),
				false, true, true);
	}

	public static MPerm getPermTitle() {
		return getCreative(12000, "title", "title", "set titles", MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }),
				false, true, true);
	}

	public static MPerm getPermHome() {
		return getCreative(13000, "home", "home", "teleport home",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY }), false, true, true);
	}

	public static MPerm getPermSethome() {
		return getCreative(14000, "sethome", "sethome", "set the home",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }), false, true, true);
	}

	public static MPerm getPermDeposit() {
		return getCreative(15000, "deposit", "deposit", "deposit money", MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER,
				Rel.MEMBER, Rel.RECRUIT, Rel.ALLY, Rel.TRUCE, Rel.NEUTRAL, Rel.ENEMY }), false, false, false);
	}

	public static MPerm getPermWithdraw() {
		return getCreative(16000, "withdraw", "withdraw", "withdraw money", MUtil.set(new Rel[] { Rel.LEADER }), false,
				true, true);
	}

	public static MPerm getPermTerritory() {
		return getCreative(17000, "territory", "territory", "claim or unclaim",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }), false, true, true);
	}

	public static MPerm getPermAccess() {
		return getCreative(18000, "access", "access", "grant territory",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }), false, true, true);
	}

	public static MPerm getPermClaimnear() {
		return getCreative(19000, "claimnear", "claimnear", "claim nearby",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY }), false, false,
				false);
	}

	public static MPerm getPermRel() {
		return getCreative(20000, "rel", "rel", "change relations", MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }),
				false, true, true);
	}

	public static MPerm getPermDisband() {
		return getCreative(21000, "disband", "disband", "disband the faction", MUtil.set(new Rel[] { Rel.LEADER }),
				false, true, true);
	}

	public static MPerm getPermFlags() {
		return getCreative(22000, "flags", "flags", "manage flags", MUtil.set(new Rel[] { Rel.LEADER }), false, true,
				true);
	}

	public static MPerm getPermPerms() {
		return getCreative(23000, "perms", "perms", "manage permissions", MUtil.set(new Rel[] { Rel.LEADER }), false,
				true, true);
	}

	public static MPerm getPermTrusted() {
		return getCreative(999, "trusted", "trusted", "do trusted actions", MUtil.set(new Rel[] { Rel.LEADER }), true,
				true, true);
	}

	public static MPerm getPermUpgrade() {
		return getCreative(998, "upgrade", "upgrade", "upgrade the faction", MUtil.set(new Rel[] { Rel.LEADER }), false,
				true, true);
	}

	public static MPerm getPermWarp() {
		return getCreative(995, "warp", "warp", "use faction warps",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER, Rel.MEMBER }), false, true, true);
	}

	public static MPerm getPermSetWarp() {
		return getCreative(996, "setwarp", "setwarp", "set faction warps",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }), false, true, true);
	}

	public static MPerm getPermDeleteWarp() {
		return getCreative(997, "deletewarp", "deletewarp", "delete faction warps",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }), false, true, true);
	}

	public static MPerm getPermSetCapital() {
		return getCreative(995, "setcapital", "setcapital", "set capital chunk", MUtil.set(new Rel[] { Rel.LEADER }),
				false, true, true);
	}

	public static MPerm getPermFly() {
		return getCreative(994, "fly", "fly", "fly in your territory",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER, Rel.MEMBER }), false, true, true);
	}

	public static MPerm getPermRecruitment() {
		return getCreative(993, "recruitment", "recruitment", "toggle recruitment status",
				MUtil.set(new Rel[] { Rel.LEADER }), false, true, true);
	}

	public static MPerm getPermURL() {
		return getCreative(992, "url", "url", "change recruitment url", MUtil.set(new Rel[] { Rel.LEADER }), false,
				true, true);
	}

	public static MPerm getPermTntTake() {
		return getCreative(991, "taketnt", "taketnt", "take tnt from storage",
				MUtil.set(new Rel[] { Rel.LEADER, Rel.OFFICER }), false, true, true);
	}

	public static MPerm getPermTntAdd() {
		return getCreative(990, "addtnt", "addtnt", "add tnt to storage",
	...
	public MPerm setEditable(boolean editable) {
	...
	public MPerm setVisible(boolean visible) {
	...
	public MPerm(int priority, String name, String desc, Set<Rel> standard, boolean territory, boolean editable,
			boolean visible) {
		this.priority = priority;
		this.name = name;
		this.desc = desc;
	...
	public String createDeniedMessage(MPlayer mplayer, Faction hostFaction) {
		...
		String ret = Txt.parse("%s<b> does not allow you to %s<b>.",
				new Object[] { hostFaction.describeTo(mplayer, true), getDesc() });

		Player player = mplayer.getPlayer();
		if ((player != null) && (Perm.OVERRIDE.has(player))) {
			ret = ret + Txt.parse(new StringBuilder("\n<i>You can bypass by using ")
					.append(CmdFactions.get().cmdFactionsOverride.getTemplate(false).toPlain(true)).toString());
		}
		return ret;
	}
	...
	public static String getStateHeaders() {
		String ret = "";
		Rel[] arrayOfRel;
		int j = (arrayOfRel = Rel.values()).length;
		for (int i = 0; i < j; i++) {
			Rel rel = arrayOfRel[i];
...
/*
 * Location:
 * C:\Users\Alan\Desktop\Factions.jar!\com\massivecraft\factions\entity\MPerm.
