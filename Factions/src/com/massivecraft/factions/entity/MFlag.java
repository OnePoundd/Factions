...
public class MFlag extends Entity<MFlag> implements Prioritized, Registerable, Named {
	...
	public static MFlag getFlagOpen() {
		return getCreative(1000, "open", "open", "Can the faction be joined without an invite?",
				"Anyone can join. No invite required.", "An invite is required to join.", false, true, true);
	}

	public static MFlag getFlagMonsters() {
		return getCreative(2000, "monsters", "monsters", "Can monsters spawn in this territory?",
				"Monsters can spawn in this territory.", "Monsters can NOT spawn in this territory.", false, true,
				true);
	}

	public static MFlag getFlagAnimals() {
		return getCreative(3000, "animals", "animals", "Can animals spawn in this territory?",
				"Animals can spawn in this territory.", "Animals can NOT spawn in this territory.", true, true, true);
	}

	public static MFlag getFlagPowerloss() {
		return getCreative(4000, "powerloss", "powerloss", "Is power lost on death in this territory?",
				"Power is lost on death in this territory.", "Power is NOT lost on death in this territory.", true,
				false, true);
	}

	public static MFlag getFlagPowergain() {
		return getCreative(5000, "powergain", "powergain", "Can power be gained in this territory?",
				"Power can be gained in this territory.", "Power is NOT gained in this territory.", true, false, true);
	}

	public static MFlag getFlagPvp() {
		return getCreative(6000, "pvp", "pvp", "Can you PVP in territory?", "You can PVP in this territory.",
				"You can NOT PVP in this territory.", true, false, true);
	}

	public static MFlag getFlagFriendlyire() {
		return getCreative(7000, "friendlyfire", "friendlyfire", "Can friends hurt eachother in this territory?",
				"Friendly fire is on here.", "Friendly fire is off here.", false, false, true);
	}

	public static MFlag getFlagExplosions() {
		return getCreative(8000, "explosions", "explosions", "Can explosions occur in this territory?",
				"Explosions can occur in this territory.", "Explosions can NOT occur in this territory.", true, false,
				true);
	}

	public static MFlag getFlagOfflineexplosions() {
		return getCreative(9000, "offlineexplosions", "offlineexplosions",
				"Can explosions occur if faction is offline?", "Explosions if faction is offline.",
				"No explosions if faction is offline.", false, false, true);
	}

	public static MFlag getFlagFirespread() {
		return getCreative(10000, "firespread", "firespread", "Can fire spread in territory?",
				"Fire can spread in this territory.", "Fire can NOT spread in this territory.", true, false, true);
	}

	public static MFlag getFlagEndergrief() {
		return getCreative(11000, "endergrief", "endergrief", "Can endermen grief in this territory?",
				"Endermen can grief in this territory.", "Endermen can NOT grief in this territory.", false, false,
				true);
	}

	public static MFlag getFlagZombiegrief() {
		return getCreative(12000, "zombiegrief", "zombiegrief", "Can zombies break doors in this territory?",
				"Zombies can break doors in this territory.", "Zombies can NOT break doors in this territory.", false,
				false, true);
	}

	public static MFlag getFlagPermanent() {
		return getCreative(13000, "permanent", "permanent", "Is the faction immune to deletion?",
				"The faction can NOT be deleted.", "The faction can be deleted.", false, false, true);
	}

	public static MFlag getFlagPeaceful() {
		return getCreative(14000, "peaceful", "peaceful", "Is the faction in truce with everyone?",
				"The faction is in truce with everyone.", "The faction relations work as usual.", false, false, true);
	}

	public static MFlag getFlagInfpower() {
		return getCreative(15000, "infpower", "infpower", "Does the faction have infinite power?",
				"The faction has infinite power.", "The faction power works as usual.", false, false, true);
	}

	public static MFlag getCreative(int priority, String id, String name, String desc, String descYes, String descNo,
			boolean standard, boolean editable, boolean visible) {
	...
	public MFlag setName(String name) {
		this.name = name;
		changed();
		return this;
	}
	...
	public MFlag setDescYes(String descYes) {
	...
	public MFlag setDescNo(String descNo) {
		this.descNo = descNo;
		changed();
		return this;
	}
	...
	public MFlag setStandard(boolean standard) {
	...
	public MFlag setEditable(boolean editable) {
	...
	public MFlag setVisible(boolean visible) {
	...
	public MFlag(int priority, String name, String desc, String descYes, String descNo, boolean standard,
	...
	public String getStateDesc(boolean value, boolean withValue, boolean monospaceValue, boolean withName,
			boolean withDesc, boolean specificDesc) {
		List<String> ret = new MassiveList();
		if (withValue) {
			ret.add(getStateValue(value, monospaceValue));
		}
		if (withName) {
			ret.add(getStateName());
		}
		if (withDesc) {
			ret.add(getStateDescription(value, specificDesc));
		}
	...
	private String getStateDescription(boolean value, boolean specific) {
		String desc = getDesc();
		if (specific) {
			desc = value ? getDescYes() : getDescNo();
		}
...
/*
 * Location:
 * C:\Users\Alan\Desktop\Factions.jar!\com\massivecraft\factions\entity\MFlag.
