...
public class MigratorMConf001EnumerationUtil extends MigratorRoot {
	...
	public void migrateInner(JsonObject entity) {
		removeFromStringsField(entity, "materialsEditOnInteract",
				EnumerationUtil.MATERIALS_EDIT_ON_INTERACT.getStringSet());
		...
		removeFromStringsField(entity, "entityTypesEditOnInteract",
				EnumerationUtil.ENTITY_TYPES_EDIT_ON_INTERACT.getStringSet());
		removeFromStringsField(entity, "entityTypesEditOnDamage",
				EnumerationUtil.ENTITY_TYPES_EDIT_ON_DAMAGE.getStringSet());
...
/*
 * Location:
 * C:\Users\Alan\Desktop\Factions.jar!\com\massivecraft\factions\entity\migrator
 * \MigratorMConf001EnumerationUtil.class Java compiler version: 8 (52.0)
