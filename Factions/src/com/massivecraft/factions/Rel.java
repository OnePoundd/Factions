...
public enum Rel implements Colorized, Named {
	...
	public String getName() {
		return (String) getNames().iterator().next();
	}

	private Rel(String descPlayerOne, String descPlayerMany, String descFactionOne, String descFactionMany,
			String... names) {
...
/*
 * Location:
 * C:\Users\Alan\Desktop\Factions.jar!\com\massivecraft\factions\Rel.class Java
