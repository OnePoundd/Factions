...
public class EngineFlagSpawn extends Engine {
	...
	public static final Set<CreatureSpawnEvent.SpawnReason> NATURAL_SPAWN_REASONS = new BackstringSet(
			CreatureSpawnEvent.SpawnReason.class, new Object[] { "NATURAL", "JOCKEY", "CHUNK_GEN", "OCELOT_BABY",
					"NETHER_PORTAL", "MOUNT", "REINFORCEMENTS", "VILLAGE_INVASION" });
 ...
 * EngineFlagSpawn.class Java compiler version: 8 (52.0) JD-Core Version: 0.7.1
 */