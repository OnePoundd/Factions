...
public class EventFactionsMembershipChange extends EventFactionsAbstractSender {
	...
	public EventFactionsMembershipChange(CommandSender sender, MPlayer mplayer, Faction newFaction,
	...
	public static enum MembershipChangeReason {
		JOIN(true), CREATE(false), LEADER(

				true), RANK(true), LEAVE(true), KICK(true), DISBAND(false);
 ...
 * EventFactionsMembershipChange.class Java compiler version: 8 (52.0) JD-Core
 * Version: 0.7.1
 */